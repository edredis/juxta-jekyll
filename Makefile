...
include-npm-deps:
	...
	cp node_modules/headroom.js/dist/headroom.min.js $(VENDOR_DIR)
...
generate-githubpages:
	rm -fr docs && JEKYLL_ENV=production $(JEKYLL) build --baseurl https://URL.COM -d docs/ && touch docs/.nojekyll
